...
execute_process(
  COMMAND "/opt/homebrew/bin/git" --git-dir=.git show-ref "4.13.1"
  WORKING_DIRECTORY "/Users/mikkelarentoft/sandbox/github/mikkela/miniml/cmake-build-debug/_deps/antlr4_runtime-src"
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  if(tag_sha STREQUAL head_sha)
    message(VERBOSE "Already at requested tag: 4.13.1")
    return()
  endif()
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/Users/mikkelarentoft/sandbox/github/mikkela/miniml/cmake-build-debug/_deps/antlr4_runtime-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/mikkelarentoft/sandbox/github/mikkela/miniml/cmake-build-debug/_deps/antlr4_runtime-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
